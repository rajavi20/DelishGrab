                  ...
                  <form className="flex flex-col gap-2">
                    <div className="w-full flex flex-col gap-2">
                      ...
                      <input
                        ...
                        placeholder="Rajavi Shah"
                        className="w-full border border-gray-400 px-3 py-2 rounded-lg focus:border-delishGrab-400"
                      />
                    </div>
                    <div className="w-full flex flex-col gap-2">
                    ...
                    <div
                      className="w-full text-center bg-delishGrab-400 text-white py-2 rounded-lg"
                      onClick={submit}
                    >
                      Sign Up
                    </div>
