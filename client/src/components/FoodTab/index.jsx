        ...
        {allTypes.map((item) => (
          <Link key={item.id} to={`/${item.id}`} className="w-1/4">
            <div
              className={
                type === item.id
                  ? "flex text-center flex-col relative items-center text-xl text-delishGrab-400"
            ...
            >
              <div
                className={
                  type === item.id
                    ? "w-full h-full border-t-2 p-3 border-delishGrab-400 flex flex-col items-center"
          ...
          <Link key={item.id} to={`/${item.id}`} className="w-36">
            <div
              className={classnames(
                ...
                {
                  "border-b-2 border-delishGrab-400": type === item.id,
                }
              )}
            >
              <div
