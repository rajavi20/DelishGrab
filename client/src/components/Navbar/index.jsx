...
function MobileNav({ SignIn, SignUp }) {
  ...
  return (
    <div className="flex w-full items-center justify-between lg:hidden">
      <div className="w-28">
        <img
          src="../delishGrab-removebg-preview.png"
          alt="delishGrab logo"
          className="w-full h-full"
        />
      </div>
      <div className="flex items-center gap-3 relative">
        <button className="bg-delishGrab-400 text-white py-2 px-3 rounded-full">
          Use App
        </button>
        {reduxState?.fullName ? (
          <>
            <div
              ...
              className="border border-gray-300 text-delishGrab-400 w-20 h-20 rounded-full"
            >
              <img
          ...
          <>
            <span
              onClick={() => setIsDropDownOpen((prev) => !prev)}
              className="border p-2 border-gray-300 text-delishGrab-400 rounded-full"
            >
        ...
        <div className="gap-4 w-full items-center justify-around flex">
          ...
          <div className="w-3/4 bg-white shadow-md p-3 flex items-center gap-3 border border-gray-200 rounded ">
            <div className="flex items-center gap-2 border-r-2 border-gray-300 pr-2">
              <span className="text-delishGrab-400">
                <HiLocationMarker />
              </span>
              <input
                type="text"
          ...
          {reduxState?.fullName ? (
            <div className="relative w-20">
              <div
                onClick={() => setIsDropDownOpen((prev) => !prev)}
                className="border border-gray-300 text-delishGrab-400 w-full h-20 rounded-full"
              >
                <img
                  src="https://cdn1.vectorstock.com/i/1000x1000/36/15/businessman-character-avatar-isolated-vector-12613615.jpg"
                  alt=""
