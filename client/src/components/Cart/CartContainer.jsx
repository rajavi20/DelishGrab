    ...
    <>
      <div className="md:hidden flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-cetenr gap-1 bg-delishGrab-400 px-3 py-1 text-white rounded-lg"
        >
  ...
  return (
    <>
      <div className="hidden md:flex items-center justify-between">
        ...
        <button
          onClick={continueToCheckout}
          className="flex items-center gap-1 bg-delishGrab-400 px-3 py-1 text-white rounded-lg"
        >
          Continue <IoMdArrowDropright />
        </button>
      </div>
