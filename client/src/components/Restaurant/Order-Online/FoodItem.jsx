          ...
          <div className="flex items-start gap-4 w-full p-1">
            ...
            <div className="w-3/4 md:w-7/12 flex flex-col gap-1">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="md:hidden flex items-center gap-2 text-delishGrab-400 bg-delishGrab-50 border border-delishGrab-400 px-2 py-1 rounded-lg"
                >
                  {food.isAddedToCart ? (
                    "Added"
                  ) : (
            ...
            <div className="hidden md:block w-2/12">
              <button
                onClick={addFoodToCart}
                disabled={food?.isAddedToCart}
                className="flex items-center gap-2 text-delishGrab-400 bg-delishGrab-50 border border-delishGrab-400 px-2 py-1 rounded-lg"
              >
                {food.isAddedToCart ? (
                  "Added"
                ) : (
